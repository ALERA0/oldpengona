...
const DokumantasyonSlider = ({ slides }) => {
            ...
            >
              ...
              >
                <Image
                  ...
                  width={200}
                  height={200}
                  className="flex bg-gray-300  justify-center items-center w-full h-2/3 object-contain hover:bg-gray-500 rounded-t-2xl duration-500"
                />
                <div className="w-full flex flex-col bg-[#160039] text-light py-4 md:px-8 px-2">
                  <div className="flex  justify-center items-center ">
                    <h2 className="text-3xl font-bold tece ">{slide.text}</h2>
...
export default DokumantasyonSlider;
